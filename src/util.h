...
// VM_INSTRUCTION:
#define VM_INSTRUCTION_GET_BY_INDEX(vm, index) \
...
// VM_STACK:
#define VM_STACK_GET_BY_INDEX(vm, index) \
    (vm->stack[index])

#define VM_STACK_GET(vm) \
    (VM_STACK_GET_BY_INDEX(vm, vm->stack_index))

#define VM_STACK_SET_BY_INDEX(vm, index, value) \
